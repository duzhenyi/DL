...
namespace DL.IService
{
    ...
    public interface IBaseService<T> where T : class
    {
        ...
        /// <returns></returns>
        Task<ApiResult<PageReply<T>>> GetPagesAsync(PageParm parm, bool Async = true);
        ...
        /// <returns></returns>
        Task<ApiResult<PageReply<T>>> GetPagesAsync(PageParm parm, Expression<Func<T, bool>> where,
            Expression<Func<T, object>> order, DbOrderEnum orderEnum, bool Async = true);
